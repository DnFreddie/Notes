...
- Dns could contains the inforamtion about user [IP](/Network/Ref_OSI/IP.md) name server (*the server that ranslates the target name name to and IP addres*)
	- **Dig shows the Dns**
		- ns for name server 
...
Allot of the times its related with [BIND](/Network/Phisicall/BIND.md)
...
>[!note]- For [DHCP server](/Network/Phisicall/DHCP server.md) 
